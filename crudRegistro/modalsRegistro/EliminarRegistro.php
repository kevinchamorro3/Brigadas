...
<div id="eliminarRegistroModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="../crudRegistro/eliminarRegistro.php" method="POST" id="delete_product">
                ...
                <div class="modal-body">					
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Usuario" name="eliminarCregistro" id="eliminar" value="" readonly required maxlength="20">
